...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_atlas": "Atlas structured data catalogue: worlds, entities (schemas with columns), and rows. Use for datasets/tabular data — NEVER store table rows in manage_memory. create_entity with attributes array; add_row/update_row/delete_row for data; import_rows for CSV bulk load (append/merge/replace). list_rows defaults to limit=20. world_id optional (default world). After create return [Name](#atlas-entity-<id>) links.",

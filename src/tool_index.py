...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_atlas": "MongoDB-style Atlas document store. Workflow: get_schema → find → updateOne/insertOne. Each doc has auto _id. find/updateMany use filter objects. insertOne/insertMany for writes. deleteMany needs confirm. NEVER store datasets in manage_memory. world_id optional. Return [Name](#atlas-entity-<id>) links.",

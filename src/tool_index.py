...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_atlas": "MongoDB-style Atlas document store. NEVER use app_api for /api/atlas/*. world_id accepts UUID, prefix, or exact world name; entity_name for collections. Orient: describe_world, find_world. list_entities is summary by default (include_fields=true for slugs). Read: find/findOne/countDocuments/search. Field details: get_schema only. Write: insertOne/updateOne; deleteMany needs confirm.",

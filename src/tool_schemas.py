...
FUNCTION_TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            "name": "manage_atlas",
            "description": "MongoDB-style document store: worlds, collections (entities), documents with auto _id. Call get_schema before writing unfamiliar collections. Use find/updateOne/updateMany with filter objects. NOT manage_memory unless user wants prose. world_id optional.",
            "parameters": {
                "type": "object",
                "properties": {
                    "action": {
                        ...
                        "description": "MongoDB-style action (legacy list_rows/add_row aliases still work)",
                    },
                    ...
                    "entity_name": {"type": "string", "description": "Entity name (lookup)"},
                    "name": {"type": "string", "description": "World or entity name"},
                    "description": {"type": "string", "description": "World or entity description"},
                    "filter": {"type": "object", "description": "MongoDB filter e.g. {\"status\":\"active\"} or {\"_id\":42}"},
                    ...
                    "limit": {"type": "integer", "description": "Max documents (default 20, max 100)"},

...
FUNCTION_TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            "name": "manage_atlas",
            "description": "MongoDB-style Atlas document store. world_id accepts UUID, 8-char prefix, or exact world name; entity_name for collections. Orient with describe_world/find_world; get_schema only when fields unknown. find supports format=compact|table and fields projection. deleteMany needs confirm on large/unfiltered sets.",
            "parameters": {
                "type": "object",
                "properties": {
                    "action": {
                        ...
                        "description": "list_worlds/find_world/describe_world for discovery; find/findOne/countDocuments for reads; insertOne/updateOne for writes; search for cross-collection text search",
                    },
